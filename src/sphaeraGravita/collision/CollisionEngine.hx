...
class CollisionEngine
{
	...
	public function collideBodies(entityOne:PhysicalBody, entityTwo:PhysicalBody):Void
	{
		...
		if (entityOne.collisionMask & entityTwo.collisionCategory == 0) 
		{
			return;
		}
			...
			while (bodyTwoShape != null) 
			{
				...
				else 
				{
					...
					if (collisionResult != null)
					{
						...
						{
							SOSLog.sosTrace( "collisionResult.collision : " + collisionResult.collision );
	...
	public function collideShapes(shapeOne:BaseShape, shapeTwo:BaseShape):Null<CollisionResult>
	{
